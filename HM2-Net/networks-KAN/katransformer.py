...
class KAN(nn.Module):
    def __init__(
        ...
        out_features=None,
        act_layer=KAT_Group,
        act_init="gelu",  # ✅ 添加 act_init 让其兼容 ViT
        norm_layer=None,
        bias=True,
        drop=0.,
        use_conv=False,
        ...
        self.act2 = KAT_Group(mode=act_init)  # ✅ 这里支持 act_init
    ...
    def _init_weights(self):
        ...
        nn.init.kaiming_normal_(self.fc2.weight, mode='fan_in', nonlinearity='gelu')  # 用 GELU 适配 KAN
