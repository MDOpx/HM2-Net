...
from datasets.data_ours import CVC_dataset
...
parser.add_argument('--volume_path', type=str,
                    default='/home/shuoxing/data/TransUNet/data/CVC_ClinicDB/npz/test', help='root dir for test volume data')
parser.add_argument('--dataset', type=str,
                    default='CVC', help='experiment_name')
parser.add_argument('--num_classes', type=int,
                    default=2, help='output channel of network')
parser.add_argument('--list_dir', type=str,
                    default='/home/shuoxing/data/TransUNet/lists/lists_CVC', help='list dir')
...
parser.add_argument('--n_skip', type=int, default=3, help='number of skip-connections to use')
...
parser.add_argument('--base_lr', type=float, default=0.01, help='learning rate for segmentation network')
...
def inference(args, model, test_save_path=None):
    ...
    测试阶段的推理函数
    """
    db_test = CVC_dataset(base_dir=args.volume_path, list_dir=args.list_dir, split="test",
                          transform=None)  # 测试阶段无需数据增强
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'CVC': {
            'Dataset': CVC_dataset,
            'volume_path': '/home/shuoxing/data/TransUNet/data/CVC_ClinicDB/npz/test',
            'list_dir': '/home/shuoxing/data/TransUNet/lists/lists_CVC',
            'num_classes': 2,
        },
    }
    ...
    if not os.path.exists(snapshot):
        logging.error(f"Snapshot {snapshot} not found!")
        sys.exit(1)
