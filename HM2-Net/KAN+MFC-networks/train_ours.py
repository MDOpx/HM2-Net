...
parser.add_argument('--root_path', type=str,
                    default='/home/shuoxing/data/TransUNet/dataset/npz/train', help='root dir for data')
...
parser.add_argument('--img_size', type=int,
                    default=256, help='input patch size of the network')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        ...
        'CVC': {
            'root_path': '/home/shuoxing/data/TransUNet/dataset/npz/train',
    ...
    snapshot_path = "/home/shuoxing/data/TransUNet/trained_model/KAT-MFC/{}".format(args.exp)
