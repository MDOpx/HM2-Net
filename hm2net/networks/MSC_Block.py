...
class MSC_Block(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(f"[MSC_Block] local1 -> min: {local1.min().item():.6f}, max: {local1.max().item():.6f}")
        # print(f"[MSC_Block] local2 -> min: {local2.min().item():.6f}, max: {local2.max().item():.6f}")
        # print(f"[MSC_Block] global1 -> min: {global1.min().item():.6f}, max: {global1.max().item():.6f}")
        # print(f"[MSC_Block] global2 -> min: {global2.min().item():.6f}, max: {global2.max().item():.6f}")
        ...
        # print(f"[MSC_Block] res_x -> min: {res_x.min().item():.6f}, max: {res_x.max().item():.6f}")
        # print(f"[MSC_Block] out0 -> min: {out.min().item():.6f}, max: {out.max().item():.6f}")
        ...
        # **🔹 打印 `out` 数值范围**
        # print(f"[MSC_Block] out -> min: {out.min().item():.6f}, max: {out.max().item():.6f}")
